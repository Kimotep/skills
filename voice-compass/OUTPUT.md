...
Generated by [voice-compass](https://github.com/Kimotep/skills) on [date].
...
Run `voice-compass` again to revise — either start fresh or describe what's changed since this 
version.
```
